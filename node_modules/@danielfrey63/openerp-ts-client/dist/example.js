...
async function main() {
    try {
        ...
        const client = new client_1.OpenERPClient(config);
        ...
        const dbChoice = await inquirer_1.default.prompt([
            {
                type: 'list',
                name: 'database',
        ...
        while (true) {
            ...
            if (action.choice === 'list_orders') {
                while (true) { // New loop for SO list level
                    ...
                    const orderChoice = await inquirer_1.default.prompt([
                        {
                            type: 'list',
                            name: 'order',
                    ...
                    console.log('-------------------');
                    const lineChoice = await inquirer_1.default.prompt([
                        {
                            type: 'list',
                            name: 'line',
                    ...
                    const productChoice = await inquirer_1.default.prompt([
                        {
                            type: 'input',
                            name: 'newProductCode',
                    ...
                    await client.updateOrderLineProduct(orderChoice.order, orderLines[lineChoice.line].product_id[0], productChoice.newProductCode);
